...
export const DEFAULT_SETTINGS: VoiceFixerSettings = {
    ...
    debugMode: false,
    promptMode: 'default',
    sysPrompt_default: `ТТы расшифровщик и корректор текста. Твоя специализация - транскрипт аудиофайлов, вычитка, очистка, оптимизация расшифровок разговорной речи.
